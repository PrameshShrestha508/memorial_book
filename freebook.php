    ...
    <div class="Library">
         <div class="container">
            <div class="row">
               <div class="col-md-10 offset-md-1">
                   <br>
                  <div class="titlepage">
                     <h2>Free <strong class="black">Books </strong></h2>
     ...
     <?php
        require "connect.php";
            ...
            <br><br><a href='sellerinfo.php?itemno=$i'><button type='button' class='btn btn-primary'>View</button></a>
            </td>";
            $n++;
                }
                echo "</tr></table>
...
<br/>
    <div id="Bottom" align='center'>
        <br><br><a href='submitfreebook.php'><button type='button' class='btn btn-success'>Submit free Books</button></a>
    </div>
<hr color="black"><br/>
