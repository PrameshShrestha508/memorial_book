...
<br/><br/><br>
<div id="RightPart">
<h1 align='center'>Enjoy  Free Content</h1>
    <?php
 require "connect.php";
 $itemno=$_REQUEST['itemno'];
	$sql="select * from freebook where BOOKID='$itemno'";
    $row = $conn->query($sql);
    $n=0;
    ...
    $rowb = $conn->query($scl);
	   ...
	   <br><b>Price:</b>".$arr['PRICE']."
        <br><b>Name:</b>&nbsp;".$name."
		 <br><b>mobileno:</b>&nbsp;".$mob."
		  <br><b>emailid:</b>&nbsp;".$emailid."<br><br>
      <a href='$link'><button type='button' class='btn btn-success'>Downloads</button></a>
